...
export default async function ThankYouPage({ params, searchParams }: PageProps) {
  ...
  const wantsContact = searchParams.wantsContact === 'true';
  const hasSocialLinks = business.websiteUrl || business.facebookUrl || business.instagramUrl || business.linkedinUrl;
